...
const COUNTRY_LOCALE: Record<string, string> = {
  ...
  PT: "pt", BR: "pt-BR",
  IT: "it", NL: "nl", PL: "pl", CZ: "cs",
  JP: "ja", KR: "ko", CN: "zh", TW: "zh-TW",
  IN: "hi", IL: "he", TR: "tr", RU: "ru", UA: "uk",
  SA: "ar", EG: "ar", AE: "ar",
  TH: "th", VN: "vi", ID: "id",
};

export const LOCALE_NAMES: Record<string, string> = {
  en: "English", sv: "Swedish", nb: "Norwegian", da: "Danish", fi: "Finnish",
  de: "German", fr: "French", es: "Spanish", "pt-BR": "Brazilian Portuguese",
  pt: "Portuguese", it: "Italian", nl: "Dutch", pl: "Polish", cs: "Czech",
  ja: "Japanese", ko: "Korean", zh: "Chinese", "zh-TW": "Traditional Chinese",
  hi: "Hindi", he: "Hebrew", tr: "Turkish", ru: "Russian", uk: "Ukrainian",
