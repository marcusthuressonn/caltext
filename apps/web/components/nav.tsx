      ...
      <div className="mx-auto max-w-150">
        <div className="flex items-center justify-between rounded-full border border-bg/70 bg-bg/72 px-3 py-2 shadow-[0_10px_30px_rgba(44,40,37,0.08),inset_0_1px_0_rgba(246,244,241,0.7)] backdrop-blur-2xl">
          <div className="flex items-center gap-2">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-[10px] border border-[#e8751a]/20 bg-[linear-gradient(145deg,#f5a623_0%,#e8751a_100%)] shadow-[0_4px_12px_rgba(245,166,35,0.45),0_12px_28px_rgba(232,117,26,0.18)]">
